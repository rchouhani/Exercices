...
const secondname = "Chouhani"
console.log(`Bonjour ${firstname} ${secondname}`)

let distance = 37.5
let age = 41

const soustraction = age - distance

console.log(`${soustraction} années à travailler avant la retraite ! Courage ! En développant, ce sera plus fun.`)
