...
const fetchWeather = async () => {
    let resp = await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${48.8534}&longitude=${2.3488}&current=temperature_2m,rain`);
    let json = await resp.json();
    return json;
}

const displayWeather = async (json) => {
      console.log("😋😋");
}
displayWeather()
